...
public class VyomApp {

    private static final Logger log = LoggerFactory.getLogger(VyomApp.class);

    private final Environment env;

    public VyomApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(VyomApp.class);
